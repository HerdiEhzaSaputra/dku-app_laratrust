<div>
    ...
    <!-- Modal -->
    <div wire:ignore.self id="deleteConfirmModal" tabindex="-1" class="ml-24 pl-24 hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 md:inset-0 h-modal md:h-full">
